...
export default function CompatibilityScreen() {
  ...
  const bloodTypes = [
    ...
    },
    {
      type: "AB+",
      color: "#9B59B6",
      description: "Universal Receiver",
      percentage: "4%",
    },
  ];
    ...
    return (
      ...
      >
        <View style={styles.cardContent}>
          ...
          <Text style={styles.bloodTypeDescription}>
            {bloodType.description}
          </Text>
          <Text style={styles.bloodTypePercentage}>
            {bloodType.percentage} of population
          </Text>
        ...
        <View style={styles.matrix}>
          ...
          {bloodTypes.map((donor) => (
            <View key={donor.type} style={styles.matrixRow}>
              <Text style={[styles.matrixLabel, { color: donor.color }]}>
                {donor.type}
              </Text>
              {bloodTypes.map((recipient) => {
                const canDonate = compatibilityMatrix[
                  donor.type as keyof typeof compatibilityMatrix
        ...
        <View style={styles.educationSection}>
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                O- blood can be donated to anyone, making it the most valuable
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                AB+ blood can receive from any blood type, but can only donate
                to other AB+ recipients.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                The + or - indicates the presence of Rh factor. Rh- can donate
                to Rh+, but not vice versa.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                Red blood cells can be stored for up to 42 days, platelets for 5
                days, and plasma for up to 1 year when frozen.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                One donation can be separated into red cells, plasma, platelets,
                and cryoprecipitate, helping multiple patients.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                O+ is the most common blood type (37%), while AB- is the rarest
                (1%). Blood type distribution varies by ethnicity.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                In emergencies, O- blood is used when the patient's blood type
                is unknown, as it's safe for everyone.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                Rh incompatibility between mother and baby can cause
                complications, which is why Rh- mothers need special care.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                Healthy adults can donate whole blood every 56 days, platelets
                every 7 days, and plasma every 28 days.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                All donated blood is tested for infectious diseases including
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                Every 2 seconds, someone in the US needs blood. A single car
                accident victim may require up to 100 pints of blood.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.factCard}>
            ...
            <View style={styles.factContent}>
              ...
              <Text style={styles.factDescription}>
                Blood types were discovered in 1901 by Karl Landsteiner, who won
                the Nobel Prize for this breakthrough.
              </Text>
            </View>
          </View>
        </View>
