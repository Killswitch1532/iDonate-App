...
export default function RequestBloodScreen() {
  ...
  const [selectedContactMethod, setSelectedContactMethod] = useState<string>('In-app chat');
      ...
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerContent}>
            <ThemedText style={styles.appName}>iDonate</ThemedText>
        ...
        <View style={styles.titleSection}>
          ...
          <ThemedText style={styles.subtitle}>Fill in the details below to create your blood request</ThemedText>
        </View>
        ...
        <View style={styles.card}>
          ...
          <ThemedText style={styles.helperText}>Select one blood type required for this request.</ThemedText>
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.urgencyButtons}>
            {urgencyOptions.map((option) => (
              ...
              >
                <MaterialIcons 
                  name={option === 'Urgent' ? 'warning' : option === 'Soon' ? 'schedule' : 'event'} 
                  size={16} 
                  color={selectedUrgency === option ? '#FFFFFF' : option === 'Urgent' ? '#E74C3C' : '#4A90E2'} 
        ...
        <View style={styles.card}>
          ...
          <View style={styles.dateTimeRow}>
            ...
            >
              <MaterialIcons name="calendar-today" size={20} color="#4A90E2" style={styles.dateTimeIcon} />
            ...
            >
              <MaterialIcons name="access-time" size={20} color="#4A90E2" style={styles.dateTimeIcon} />
              <View style={styles.dateTimeContent}>
        ...
        <View style={styles.card}>
          ...
          <ThemedText style={styles.helperText}>Faster matching when a precise center is set.</ThemedText>
        </View>

        {/* Discovery Toggle */}
        <View style={styles.card}>
          <ThemedText style={styles.label}>Allow nearby donors to see this</ThemedText>
            ...
            {contactMethods.map((method) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  selectedContactMethod === method && styles.selectedContactButton
                ]}
                onPress={() => setSelectedContactMethod(method)}
              >
                <ThemedText style={[
                  styles.contactText,
                  selectedContactMethod === method && styles.selectedContactText
                ]}>
                  {method}
                </ThemedText>
              </TouchableOpacity>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.inputContainer}>
            <MaterialIcons name="note" size={20} color="#7F8C8D" style={styles.inputIcon} />
            <TextInput
        ...
        <View style={styles.card}>
          <View style={styles.settingRow}>
            ...
            <ThemedText style={styles.settingValue}>Anonymous to donors</ThemedText>
          </View>
        </View>
        ...
        <View style={styles.bottomButtons}>
          <TouchableOpacity style={styles.saveDraftButton} onPress={handleSaveDraft}>
            <MaterialIcons name="save" size={20} color="#2C3E50" style={styles.buttonIcon} />
